...
public class AdsJsonPOJO {
    ...
    public static class ParametersDTO {
        private PageShowDTO pageShow;
        private BannerIdDTO banner_id;
        private AppOpenAd1DTO app_open_ad1;
        private NativeIdDTO native_id;
        private ShowAdDTO showAd;
        private AppOpenAdDTO app_open_ad;
        private RewardedAdDTO rewarded_ad;
        private FullIdDTO full_id;
        private NativeHDTO native_h;
        private CollapsibleAdDTO collapsibleAd;
        ...
        public CollapsibleAdDTO getCollapsibleAd() {
            return collapsibleAd;
        }

        public void setCollapsibleAd(CollapsibleAdDTO collapsibleAd) {
            this.collapsibleAd = collapsibleAd;
        }
        ...
        public static class CollapsibleAdDTO {
            private DefaultValueDTO defaultValue;
            private String valueType;
